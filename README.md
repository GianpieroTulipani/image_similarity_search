...
│                         image_similarity_search and configuration for tools like black
│
...
│
└── image_similarity_search   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes image_similarity_search a Python module
    │
